...
{{--                <span class="h-5 w-5 inline-flex items-center justify-center bg-primary text-white rounded-full"><i class="ti ti-star-filled text-sm"></i></span>--}}
                <span class="text-default-400 text-base line-through">₦215,000</span>
                    ...
                    <div class="flex items-center justify-between gap-2">
                        <h4 class="font-semibold text-xl text-primary">₦200,000</h4>
...
{{--                <span class="h-5 w-5 inline-flex items-center justify-center bg-primary text-white rounded-full"><i class="ti ti-star-filled text-sm"></i></span>--}}
            ...
            <div class="border border-default-200 rounded-xl overflow-hidden duration-500 hover:border-primary relative">
                <div class="p-4">
                    <div class="relative">
                        <img src="{{ asset('greencart/chair1.png') }}" alt="" class="w-full h-full">
                        <div class="absolute top-0 end-0">
                            <span class="inline-flex items-center gap-1.5 py-1 px-4 rounded-lg text-sm font-medium bg-red-500/10 text-red-500">Hot</span>
                        </div>
                    </div>
                ...
                <div class="border-t border-dashed border-default-200 p-4 whitespace-nowrap">
                    <div class="mb-4">
                        <a href="https://wa.me/2349157688075" class="text-default-600 text-xl font-semibold line-clamp-1 after:absolute after:inset-0 after:z-0">GamingChair_Black|red</a>
                    </div>
                    <div class="flex items-center justify-between gap-2 mb-4">
              <span class="flex items-center gap-2">
{{--                <span class="h-5 w-5 inline-flex items-center justify-center bg-primary text-white rounded-full"><i class="ti ti-star-filled text-sm"></i></span>--}}
            ...
            <div class="border border-default-200 rounded-xl overflow-hidden duration-500 hover:border-primary relative">
                <div class="p-4">
                    <div class="relative">
                        <img src="{{ asset('greencart/table4.png') }}" alt="" class="w-full h-full">
                        <div class="absolute top-0 end-0">
                            <span class="inline-flex items-center gap-1.5 py-1 px-4 rounded-lg text-sm font-medium bg-red-500/10 text-red-500">Hot</span>
                        </div>
                    </div>
                ...
                <div class="border-t border-dashed border-default-200 p-4 whitespace-nowrap">
                    <div class="mb-4">
                        <a href="https://wa.me/2349157688075" class="text-default-600 text-xl font-semibold line-clamp-1 after:absolute after:inset-0 after:z-0">Normal Table | Black
                        </a>
                    </div>
                    <div class="flex items-center justify-between gap-2 mb-4">
              <span class="flex items-center gap-2">
{{--                <span class="h-5 w-5 inline-flex items-center justify-center bg-primary text-white rounded-full"><i class="ti ti-star-filled text-sm"></i></span>--}}
                <span class="text-default-400 text-base line-through">₦190,000</span>
              </span>
                        <div class="relative z-10 inline-flex justify-between border border-default-200 p-1 rounded-full" data-hs-input-number>
                            <button class="shrink bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center" type="button" data-hs-input-number-decrement>
                                <i class="ti ti-minus"></i>
                    ...
                    <div class="flex items-center justify-between gap-2">
                        <h4 class="font-semibold text-xl text-primary">₦170,000</h4>
                        <a href="https://wa.me/2349157688075" class="shrink flex items-center justify-center rounded-lg bg-primary/20 text-primary px-6 py-2.5 text-center text-sm font-medium shadow-sm transition-all duration-200 hover:bg-primary hover:text-white relative z-10">
                            <i class="ti ti-shopping-bag text-xl me-2"></i>
                            <span>Add to cart</span>
                        </a><!-- end btn -->
            ...
            <div class="border border-default-200 rounded-xl overflow-hidden duration-500 hover:border-primary relative">
                <div class="p-4">
                    <div class="relative">
                        <img src="{{ asset('greencart/table3.png') }}" alt="" class="w-full h-full">
                        <div class="absolute top-0 end-0">
                            <span class="inline-flex items-center gap-1.5 py-1 px-4 rounded-lg text-sm font-medium bg-red-500/10 text-red-500">Hot</span>
                        </div>
                    </div>
                ...
                <div class="border-t border-dashed border-default-200 p-4 whitespace-nowrap">
                    <div class="mb-4">
                        <a href="https://wa.me/2349157688075" class="text-default-600 text-xl font-semibold line-clamp-1 after:absolute after:inset-0 after:z-0">Electic Table | black
                        </a>
                    </div>
                    <div class="flex items-center justify-between gap-2 mb-4">
              <span class="flex items-center gap-2">
{{--                <span class="h-5 w-5 inline-flex items-center justify-center bg-primary text-white rounded-full"><i class="ti ti-star-filled text-sm"></i></span>--}}
                <span class="text-default-400 text-base line-through">₦310,000</span>
              </span>
                        <div class="relative z-10 inline-flex justify-between border border-default-200 p-1 rounded-full" data-hs-input-number>
                            <button class="shrink bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center" type="button" data-hs-input-number-decrement>
                                <i class="ti ti-minus"></i>
                    ...
                    <div class="flex items-center justify-between gap-2">
                        <h4 class="font-semibold text-xl text-primary">₦260,000
                        </h4>
                        <a href="https://wa.me/2349157688075" class="shrink flex items-center justify-center rounded-lg bg-primary/20 text-primary px-6 py-2.5 text-center text-sm font-medium shadow-sm transition-all duration-200 hover:bg-primary hover:text-white relative z-10">
                            <i class="ti ti-shopping-bag text-xl me-2"></i>
                            <span>Add to cart</span>
            ...
            <div class="border border-default-200 rounded-xl overflow-hidden duration-500 hover:border-primary relative">
                <div class="p-4">
                    <div class="relative">
                        <img src="{{ asset('greencart/table2.png') }}" alt="" class="w-full h-full">
                        <div class="absolute top-0 end-0">
                            <span class="inline-flex items-center gap-1.5 py-1 px-4 rounded-lg text-sm font-medium bg-red-500/10 text-red-500">Hot</span>
                        </div>
                    </div>
...
{{--                        <div class="relative h-full bg-no-repeat bg-cover bg-[url(../images/banner/banner-11.jpg)] rounded-xl overflow-hidden p-10">--}}
                            <div
                                class="relative h-full bg-no-repeat bg-cover bg-right-top rounded-xl overflow-hidden p-10"
                                style="background-image: url('{{ asset('greencart/assets/hero1.png') }}')"
                            >
                            <div class="absolute inset-0 bg-black/60 md:bg-black/40"></div>
                            <div class="relative">
                                <h3 class="text-3xl/snug italic text-white font-semibold max-w-xl line-clamp-2">Level Up Your Comfort. Dominate Every Game.
                                </h3>
                                <p class="text-base font-medium text-white/80 max-w-lg mt-4 mb-8">Experience next-level comfort with ergonomic gaming chairs built for long sessions, intense battles, and total focus. Designed for gamers who play to win.
                                </p>
    ...
    <div class="relative bg-primary/20 backdrop-blur-xl py-16">
        <div class="container">
            <div class="grid lg:grid-cols-2 items-center">
                <div class="">
                    <h2 class="text-lg sm:text-xl lg:text-3xl/normal font-bold text-default-900 max-w-xl">Your gaming setup deserves more than an ordinary chair. Invest in comfort, performance, and style.</h2>
                    <p class="text-base/normal text-default-600 md:font-medium max-w-xl mt-4">Choose how many chairs you need for your setup or team. Whether you're a solo gamer or a team of champions, we've got you covered.</p>
                </div>
                <div class="hidden lg:block">
                    <img src="{{ asset('greencart/img.png') }}" alt="" class="h-80 mx-auto">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="grid gap-x-6 gap-y-10 xl:grid-cols-8">
                    <div class="xl:col-span-2">
                        <a href="#" class="logo flex items-center gap-2">
                            <img src="{{asset('greencart/assets/newlogo.png')}}" class="hidden h-10 dark:block" alt="" />
                            <img src="{{asset('greencart/assets/newlogo1.png')}}" class="block h-10 dark:hidden" alt="" />
                        </a>

                        <p class="mt-6 max-w-xs text-base font-medium text-default-600">
                            AiwComfort offers premium gaming chairs designed for comfort. Whether you're gaming, working, or streaming, our chairs and tables provide the support you need for long hours of sitting.
                        </p>
                        <div class="mt-6 flex flex-wrap gap-2">
                            <a href="" target="_blank" class="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all duration-200 hover:bg-primary-600">
                                <i class="ti ti-brand-appgallery me-2 text-xl"></i> Buy Now
                            </a>
            ...
            <div class="container">
                <div class="grid items-center gap-6 py-4 lg:grid-cols-3">
                    <p class="flex text-center text-default-900 lg:col-span-2 lg:text-start">
                        ...
                        © AiwComfort. All Rights Reserved
                    </p>
                    <ul class="flex flex-wrap items-center justify-center gap-2 lg:justify-end">
                        <li>
                            <a href="https://www.tiktok.com/@furgle_gaming_chair25?_r=1&_t=ZS-93Hi7cZ1KZU" class="group inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-primary/20 text-primary backdrop-blur-xl transition-all duration-500 hover:bg-primary/30"><i class="ti ti-brand-tiktok text-2xl"></i></a>
                        </li>
                        <li>
            ...
            <div class="pointer-events-auto relative p-4">
                <div class="grid items-center gap-6 md:grid-cols-2">
                    ...
                    <div class="hidden md:flex">
                        <img src="{{ asset('greencart/footer.png')  }}" class="h-full w-full rounded-lg" alt="offer images" />
                    </div>
                    <!-- Modal CLose Button -->
